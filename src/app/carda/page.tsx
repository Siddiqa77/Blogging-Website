...
const Blog = () => {
  ...
  <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
    <img
      className="w-full h-60 object-cover object-center md:h-[100%] lg:h-[100%] rounded"
    ...
    <div className="p-8">
      ...
      In today is rapidly evolving technological landscape, the intersection of artificial intelligence (AI) and education is not just a future possibility it is imminent.
