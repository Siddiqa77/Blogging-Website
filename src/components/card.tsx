      ...
      <div className="p-4 md:w-1/3">
        <div className=" card  h-full border-2 border-gray-200  rounded-lg overflow-hidden">
          ...
          SocialMedia & Digital Marketing
            ...
            <p className="leading-relaxed mb-3">
            Digital marketing encompasses a broad range of online marketing activities beyond social media,
             including websites, email, SEO, PPC and more. 
            </p>
            <div className="flex items-center flex-wrap">
      ...
      <div className="p-4 md:w-1/3">
        <div className=" card  h-full border-2 border-gray-200  rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">
            The right fashion for your lifestyle is to be healthy. Fashion is a big domain in which you occupy trends,
             clothes, shoes, bags, accessories, makeup, hairstyle, body posture, etc.
            </p>
            <div className="flex items-center flex-wrap ">
      ...
      <div className="p-4 md:w-1/3">
        <div className="card  h-full border-2 border-gray-200  rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">
            Finance is centered primarily on the management of money, and involves
             assessing different components of financial systems, such as banking, credit, and investments. 
            </p>
            <div className="flex items-center flex-wrap ">
      ...
      <div className="p-4 md:w-1/3">
        <div className="card  h-full border-2 border-gray-200  rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">
            A tech conference often includes professional speakers,
             a series of conference sessions where people can network and improve their skills, workshops and much more.
            </p>
            <div className="flex items-center flex-wrap ">
